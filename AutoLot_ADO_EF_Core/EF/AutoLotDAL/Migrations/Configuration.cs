...
namespace AutoLotDAL.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<AutoLotDAL.EF.AutoLotDbContext>
    {
        ...
        protected override void Seed(AutoLotDAL.EF.AutoLotDbContext context)
        {
